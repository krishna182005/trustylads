...
import { X, Mail, Shield, Clock, AlertCircle, Copy } from 'lucide-react';
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-green-800">Development Mode - OTP Code</h3>
                    <p className="text-sm text-green-700 mt-1">
                      For testing purposes, your OTP is: <span className="font-mono font-bold text-lg">{displayOTP}</span>
                    </p>
                    <p className="text-xs text-green-600 mt-1">
                      You can copy this code or enter it manually in the field below.
                    </p>
                  </div>
                </div>
                <button
