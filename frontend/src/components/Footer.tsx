        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/shop?category=trending" onClick={scrollToTop} className="text-gray-300 hover:text-yellow-400 transition-colors">Trending</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/returns" onClick={scrollToTop} className="text-gray-300 hover:text-yellow-400 transition-colors">Returns & Exchange</Link></li>
