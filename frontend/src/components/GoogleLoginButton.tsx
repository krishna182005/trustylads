...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
  ...
  const { signInWithGoogle, isLoading, isAuthenticated, isInitialized } = useGoogleAuth();
  ...
  const baseClasses = 'flex items-center justify-center space-x-2 font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2';
  ...
  return (
    ...
    >
      ...
      <span>
        {children || (isAuthenticated ? 'Signed In' : 
