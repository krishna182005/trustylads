    ...
    >
      <Link to={`/product/${product._id}`} className="block" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
        <div className="relative overflow-hidden">
          <img
            src={getSafeImageUrl(primaryImage?.url || '')}
            alt={product.name}
            loading="lazy"
        ...
        <div className="p-2 sm:p-3">
          <h3 className="font-semibold text-gray-900 mb-1 text-sm h-8 overflow-hidden" style={{
            display: '-webkit-box',
            WebkitLineClamp: 2,
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="flex-1 bg-black text-white font-medium py-2 px-3 rounded hover:bg-gray-800 transition-colors text-xs text-center disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={product.totalStock === 0}
              className="bg-yellow-400 text-black font-medium py-2 px-3 rounded hover:bg-yellow-500 transition-colors text-xs disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center"
