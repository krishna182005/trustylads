...
export default function TrustBadges(props?: { className?: string }) {
  return (
    <section 
      className={`bg-white dark:bg-neutral-900 ring-1 ring-black/5 dark:ring-white/10 rounded-2xl shadow-sm p-3 sm:p-4 ${props?.className || ''}`}
      role="region" 
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3">
        {/* SSL Secure Checkout */}
        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white dark:bg-white border border-gray-200 dark:border-gray-300">
          <Lock 
            className="w-4.5 h-4.5 md:w-5 md:h-5 text-green-600 dark:text-green-400" 
            aria-hidden="true" 
          />
        ...
        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white dark:bg-white border border-gray-200 dark:border-gray-300">
          <Wallet 
            className="w-4.5 h-4.5 md:w-5 md:h-5 text-blue-600 dark:text-blue-400" 
            aria-hidden="true" 
          />
          <span className="text-sm md:text-base font-medium text-black dark:text-black">
        ...
        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white dark:bg-white border border-gray-200 dark:border-gray-300">
          <ShieldCheck 
            className="w-4.5 h-4.5 md:w-5 md:h-5 text-purple-600 dark:text-purple-400" 
            aria-hidden="true" 
          />
          <span className="text-sm md:text-base font-medium text-black dark:text-black">
            7-Day Easy Returns
        ...
        <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white dark:bg-white border border-gray-200 dark:border-gray-300">
          <Truck 
            className="w-4.5 h-4.5 md:w-5 md:h-5 text-orange-600 dark:text-orange-400" 
            aria-hidden="true" 
          />
          <span className="text-sm md:text-base font-medium text-black dark:text-black">
            Fast Shipping
