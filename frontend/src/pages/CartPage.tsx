...
const CartPage: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Shopping Cart - TrustyLads"
        description="Review your items and proceed to checkout. Secure shopping with TrustyLads."
        canonical="https://www.trustylads.tech/cart"
        noindex={true}
      />
                ...
                <div className="space-y-6">
                  {items.map((item, index) => (
                    <motion.div
                      ...
                      className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 pb-6 border-b border-gray-200 last:border-b-0 last:pb-0"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      <div className="flex items-center space-x-3 w-full sm:w-auto">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="font-semibold text-gray-900 mt-1 text-sm sm:text-base">₹{item.price.toLocaleString()}</p>
                      ...
                      <div className="flex items-center justify-between w-full sm:w-auto sm:justify-start sm:space-x-2">
          ...
          >
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 sticky top-8">
              ...
              <div className="space-y-3 mb-6">
                ...
                {discountAmount > 0 && (
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 text-green-600 text-xs sm:text-sm">Discount ({discountPercentage}% off)</span>
                    <span className="font-medium text-green-600 text-sm sm:text-base">-₹{discountAmount.toLocaleString()}</span>
                  </div>
                )}
                ...
                <div className="flex justify-between text-gray-500">
                  <span className="text-gray-600 text-xs sm:text-sm">Includes all taxes</span>
                </div>
                
                <div className="border-t pt-3">
                  <div className="flex justify-between items-center">
                    <span className="text-base sm:text-lg font-semibold">Total</span>
                    <span className="text-base sm:text-lg font-bold text-gray-900 break-all">₹{total.toLocaleString()}</span>
                  </div>
                </div>
              </div>
