...
const CheckoutPage: React.FC = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      console.log('Customer data:', cleanCustomer);
      console.log('Shipping data:', cleanShipping);
      ...
      if (checkoutData.paymentMethod === 'razorpay') {
        ...
        await initiateRazorpayPayment(
          ...
          async (razorpayResponse) => {
            ...
            if (verifyResponse) {
              ...
              // Refresh user data to update orderCount
              if (isAuthenticated) {
                await refreshUser();
              }
        ...
        try {
          ...
          if (orderId) {
            ...
            // Also invalidate user query to ensure fresh data
