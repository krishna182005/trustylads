  ...
  return (
    <>
      <SEO 
        ...
        description="Premium products collection for the bold and confident. Made in India, for India. Shop trendy streetwear, watches, jewelry and more."
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://www.trustylads.tech/site-banner-2.jpg)'
          }}
        ></div>
      ...
      {/* Sentry Test Section - Only in Development */}
      {import.meta.env.DEV && (
        <section className="py-8 bg-red-50 border-t border-red-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-lg sm:text-xl font-bold text-red-800 mb-2">Sentry Error Monitoring Test</h3>
              <p className="text-sm text-red-600 mb-4">
                This section is only visible in development mode. Click the button below to test Sentry error tracking.
              </p>
              <button
                onClick={() => {
                  // Test Sentry error tracking
                  Sentry.captureException(new Error('Test error from TrustyLads HomePage'));
