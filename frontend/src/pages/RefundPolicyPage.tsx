            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-600 mb-6">
                  <p>You can cancel your order if it's in "Processing" or "Packed" status:</p>
                  <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                    <h4 className="font-semibold text-orange-800 mb-2">How to Cancel Your Order:</h4>
              ...
              <section>
                ...
                <div className="space-y-3 text-gray-600">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p>No. 12, 3rd Cross Street, Ambattur Industrial Estate, Chennai – 600058, Tamil Nadu</p>
                    <p>Phone: <a href="tel:+916369360104" className="text-yellow-600 hover:text-yellow-700">+91 6369360104</a></p>
