...
const ShopPage: React.FC = () => {
  ...
  const { isAuthenticated, syncOrderCountFromBackend } = useAuthStore();
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (!document.hidden && isAuthenticated) {
        console.log('🔄 Shop page became visible, syncing order count...');
        syncOrderCountFromBackend();
      }
    };
    ...
    const handleFocus = () => {
      if (isAuthenticated) {
        console.log('🔄 Shop page focused, syncing order count...');
        syncOrderCountFromBackend();
      }
    };
  ...
  return (
    <>
      <SEO 
        title="Shop - TrustyLads"
        description="Browse our collection of premium products. Find trendy streetwear, watches, jewelry and more at TrustyLads."
        canonical="https://www.trustylads.tech/shop"
      />
