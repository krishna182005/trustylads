...
export const initiateRazorpayPayment = async (
  ...
  try {
    ...
    const options: RazorpayOptions = {
      // In mock mode, do not provide a key so we simulate success
      key: isMockOrder ? undefined : (order.key || import.meta.env.VITE_RAZORPAY_KEY_ID),
      amount: order.amount,
      currency: order.currency || 'INR',
      name: 'TrustyLads',
      description: 'Streetwear that screams YOU',
      image: 'https://github.com/user-attachments/assets/fb7d6d7c-3b23-4df7-b521-a48b99250326',
